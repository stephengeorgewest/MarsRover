...
#define ROVER_GROUP_WATCHDOG "224.9.1.1"
#define ROVER_PORT_WATCHDOG 4911
#define ROVER_MAGIC_WATCHDOG 11
#define WATCHDOG_SET_ZEROS 0
#define WATCHDOG_RESET_WHEELS 1
#define WATCHDOG_RESET_ARM 2
#define WATCHDOG_RESET_ALL 3
